    ...
    const events = [
      {
        ...
        description: {
          venue: { name: "Wembley Stadium", location: "London, UK", capacity: 90000 },
      ...
      },
      {
        ...
        description: {
          venue: { name: "Stade de France", location: "Paris, France", capacity: 81000 },
          ...
          ageRestriction: "All ages",
          additionalInfo: "Sustainable merchandise available. LED wristbands provided."
        }
      },
      {
        ...
        description: {
          venue: { name: "Madison Square Garden", location: "New York, USA", capacity: 20000 },
          ...
          ageRestriction: "13+",
          additionalInfo: "Light sticks available for purchase. Fan meet-and-greet for VIP."
        }
      }
    ];
